...
const (
	FinalizerString = "finalizers.cloudwatchlogs.services.k8s.aws/ResourcePolicy"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("resourcepolicies")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.ResourcePolicy{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.ResourcePolicy),
	}
}
