...
// +kubebuilder:rbac:groups=cloudwatchlogs.services.k8s.aws,resources=resourcepolicies,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=cloudwatchlogs.services.k8s.aws,resources=resourcepolicies/status,verbs=get;update;patch
